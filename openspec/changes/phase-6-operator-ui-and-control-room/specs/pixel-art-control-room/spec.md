...
- Defining sprite upload transport details.
- Defining admin forms or graph-editor interaction details.
- Replacing the declared visual reference with a generic dashboard style.
