...
- Defining model routing or cost controls.
- Defining vulnerability scan tooling or image attestation details.
- Defining human review procedures outside registered exception paths.
