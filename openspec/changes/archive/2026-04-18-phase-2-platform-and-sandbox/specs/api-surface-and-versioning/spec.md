...
- Defining auth scopes, HMAC verification, or rate-limit policies in detail.
- Defining frontend page design or routing.
- Defining implementation framework details beyond the public contract.
