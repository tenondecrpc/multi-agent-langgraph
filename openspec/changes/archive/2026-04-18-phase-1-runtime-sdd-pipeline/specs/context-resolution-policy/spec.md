...
- Granting unrestricted external research to all roles.
- Introducing a separate vector database or external knowledge plane.
- Defining UI workflows for manual context curation.
