...
- Defining backend auth middleware or provider routing internals.
- Defining the pixel-art scene composition in detail.
- Defining CI or deployment rollout logic.
