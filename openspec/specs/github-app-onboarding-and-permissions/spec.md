# github-app-onboarding-and-permissions Specification

## Purpose
Define the tenant-scoped GitHub App installation lifecycle, PAT opt-in constraints, permission enforcement, permission drift detection, and branch-protection verification required before PR creation.
