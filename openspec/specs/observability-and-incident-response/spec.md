...
Runbooks SHALL live under `docs/runbooks/`, and alert rules SHALL live under `operations/alerts/`. Deleting an alert without deleting or updating its runbook SHALL be blocked by CI.
